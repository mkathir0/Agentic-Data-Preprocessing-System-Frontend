...
const messages = [
  'Received: "Analyze and clean the uploaded dataset..."',
  ...
  "Tool: profile_data → schema drafted, pending approval",
  "Tool: flag_anomalies → null values found in age column",
  "Tool: generate_report → cleanup script generated",
...
export default function EnterpriseAIPipeline() {
  ...
  return (
    <div className="bg-[#090909]/80 backdrop-blur-xl border border-white/[0.08] rounded-[14px] overflow-hidden font-sans w-full max-w-[620px] mx-auto shadow-2xl">
      {/* Header */}
      <div className="px-[18px] py-[11px] border-b border-white/[0.06] flex items-center justify-between">
        <div className="flex items-center gap-[7px]">
          <motion.span
            className="w-[6px] h-[6px] rounded-full bg-green-500 inline-block shadow-[0_0_8px_rgba(34,197,94,0.8)]"
      ...
      <svg width="100%" viewBox="0 0 580 172" className="block">
        ...
        <text x="66" y="83" textAnchor="middle" fontSize="9.5" fill="rgba(255,255,255,0.4)" fontFamily="inherit" letterSpacing=".07em">TRIGGER</text>
        ...
        <text x="66" y="122" textAnchor="middle" fontSize="8.5" fill="rgba(255,255,255,0.25)" fontFamily="monospace">node-01</text>

        {/* Vector DB Node */}
        <rect x="158" y="66" width="110" height="44" rx="8" fill="#1A1A1A" stroke="rgba(255,255,255,0.12)" strokeWidth="0.5" />
        <text x="213" y="83" textAnchor="middle" fontSize="9.5" fill="rgba(255,255,255,0.4)" fontFamily="inherit" letterSpacing=".07em">KNOWLEDGE</text>
        <text x="213" y="100" textAnchor="middle" fontSize="12" fill="rgba(255,255,255,0.9)" fontFamily="inherit" fontWeight="500">Schema Search</text>
        ...
        <text x="490" y="53.5" textAnchor="middle" fontSize="11" fill="rgba(255,255,255,0.75)" fontFamily="inherit">Code Gen</text>
        ...
        <text x="490" y="91.5" textAnchor="middle" fontSize="11" fill="rgba(255,255,255,0.75)" fontFamily="inherit">Data Profiling</text>
        <StatusIndicator cx={550} cy={81} color="#f59e0b" pulsing duration={1.9} />

        <rect x="448" y="111" width="116" height="30" rx="7" fill="#141414" stroke="rgba(255,255,255,0.09)" strokeWidth="0.5" />
        <text x="490" y="129.5" textAnchor="middle" fontSize="11" fill="rgba(255,255,255,0.75)" fontFamily="inherit">Validation</text>
      ...
      {/* Stats Footer */}
      <div className="border-t border-white/[0.06] px-[18px] py-[10px] flex gap-[22px] items-center bg-black/40">
        <div>
          <div className="text-[9px] text-white/30 tracking-[0.09em] mb-[3px] font-semibold">PIPELINES RUN</div>
          <motion.div key={workflows} initial={{ scale: 1.05 }} animate={{ scale: 1 }} className="text-[16px] text-white/[0.85] font-mono font-medium">
            {workflows.toLocaleString()}
          </motion.div>
        </div>
        <div>
          <div className="text-[9px] text-white/30 tracking-[0.09em] mb-[3px] font-semibold">TOKENS</div>
          <div className="text-[16px] text-white/[0.85] font-mono font-medium">1.2M</div>
        </div>
        <div>
          <div className="text-[9px] text-white/30 tracking-[0.09em] mb-[3px] font-semibold">AVG LATENCY</div>
          <div className="text-[16px] text-white/[0.85] font-mono font-medium">1.4s</div>
        </div>
